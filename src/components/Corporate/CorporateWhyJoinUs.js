      ...
      <div className="CorporateWhyJoinUs col-12">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm aaaa">
              <img className="d-flex justify-content-center" src={require("./assets/images/icon_b.png")} alt="flexbox" />
              <p>corporate trip</p>
            ...
            <div class="col-sm aaaa">
            <img className="d-flex justify-content-center" src={require("./assets/images/icon_c.png")} alt="flexbox" />
              <p>easy bill</p>
            ...
            <div class="col-sm aaaa">
            <img className="d-flex justify-content-center" src={require("./assets/images/icon_d.png")} alt="flexbox" />
              <p>invite coworkers</p>
