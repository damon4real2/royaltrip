...
function EarningsRider() {
    return (
        <div className="container EarningsRider">
            ...
            <div className="container-fluid earnings-quote-driver">“My joy in this partnership is the benefit that comes with driving on RoyalTrip platform. Owning a home within 6 months, Access to hire pirchase within 3 months is not something i get to hear, except with royaltrip drivers.”<br></br><br></br>— Seun”</div>
          </div>
