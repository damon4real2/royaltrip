            ...
            <img className="HeroFindADriverImg" src={require("./assets/images/Bg.svg")} alt="heroBackground" />
              <div className="col-12 HeroFindADriverText"> 
                <div className="carousel-caption caption-rider">
                  ...
                  <h3>Every day, we collect customers' feedback, implement ideas and to serve you better. Our commitment is to give you a safe,  comfortable and delightful experience with RoyalTrip. <br></br>Use these links below to get our App and find a Driver Now!</h3>
