After every commit, wait for like 2-3 minutes depending on the load or the workdone for the images to build, check the url.... http://royaltrips.royalcrystalairwaysadmin.space/
